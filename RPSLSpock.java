...
/**
*@author - Rafael Miyamoto, CSCI-2467, Lab 7.
*/
...
/**
 * @param – String pick, the typed value
 * @return – boolean, returns true if the picked value is a valid value in (ROCK, PAPER, SCISSORS, LIZARD, SPOCK)
 */
    ...
    /**
     * @return – String, Generates and returns a random string in (ROCK, PAPER, SCISSORS, LIZARD, SPOCK)
     */
    ...
    /**
     *@param – String c_pick - the value which the computer picker,
     *         String h_pick - the value which the player typed
     * @return – boolean, returns true if the computer wins else returns false
     */
